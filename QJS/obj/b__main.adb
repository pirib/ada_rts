...
package body ada_main is
   ...
   E135 : Short_Integer; pragma Import (Ada, E135, "chore_E");
   E141 : Short_Integer; pragma Import (Ada, E141, "external_package_E");
   E143 : Short_Integer; pragma Import (Ada, E143, "hps_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "hps__finalize_spec");
      begin
         F1;
      end;
      E135 := E135 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "chore__finalize_spec");
      begin
         F2;
      end;
      E099 := E099 - 1;
